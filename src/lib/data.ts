...
export const PROJECTS: Project[] = [
    ...
    githubUrl: "https://github.com/nayeem-miah/lms-client",
  ...
  },
  {
    ...
    title: "ShopNative",
    description:
      "Feature-rich e-commerce mobile app with AR try-on, personalized recommendations, and one-tap checkout.",
    category: "mobile",
    tech: ["Flutter", "Dart", "Firebase", "Stripe"],
    image: "/projects/shopnative.png",
  ...
  },
  {
    ...
    image: "/projects/creatorspace.png",
  ...
  },
  {
    ...
    title: "AuthForge",
    description:
      "Production-ready auth microservice with OAuth2, RBAC, MFA, and audit logging — drop-in for any stack.",
    category: "backend",
