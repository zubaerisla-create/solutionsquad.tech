...
const TEAM = [
  ...
  },
  {
    ...
    bio: "Operating system enthusiast and software developer, passionate about building efficient and reliable systems.",
    avatar: "https://i.ibb.co.com/b5g4tH0s/hayat01.jpg",
    linkedin: "https://www.linkedin.com/in/abu-hayat-716a49328/",
    skills: ["Operating Systems", "C/C++", "System Architecture"],
  },
  {
    name: "Abdullah Al Zubaer",
    role: "Full Stack Developer",
    bio: "Versatile full stack developer with expertise in TypeScript, Golang, and Docker, building robust and scalable applications.",
    ...
    bio: "Experienced sales communicator with a knack for building relationships and closing deals across borders.",
